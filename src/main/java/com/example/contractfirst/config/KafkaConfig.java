 ...
 * - Manual offset commits for transactional processing
 *
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false); // Manual commits for transactional processing
